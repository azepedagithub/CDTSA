...
{
    public partial class frmConsultaDetalleDiario : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public frmConsultaDetalleDiario()
        {
            InitializeComponent();
        ...
        {
            _dsAsiento = AsientoDAC.GetConsultaDetalleAsientoMayor(_Asiento, _TipoAsiento, sCuentasSelected, sCentrosSelected, _ModuloFuente, _FechaInicial, _FechaFinal, sUsuario, false);
