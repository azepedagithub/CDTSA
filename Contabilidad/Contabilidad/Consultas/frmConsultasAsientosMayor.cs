...
{
    public partial class frmConsultasAsientosMayor : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public frmConsultasAsientosMayor()
        {
            InitializeComponent();
        ...
        {
            _dsAsiento = AsientoDAC.GetConsultaAsientosMayor(_Asiento,_TipoAsiento,_ModuloFuente,_FechaInicial, _FechaFinal, sUsuario);
