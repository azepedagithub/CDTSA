...
namespace CO
{
	public partial class frmCondicionesDePago : DevExpress.XtraBars.Ribbon.RibbonForm
	{
		...
		{
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosComprasType.AgregarCondicionesdePagos, _dtSecurity))
				this.btnAgregar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosComprasType.EditarCondicionesdePagos, _dtSecurity))
				this.btnEditar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosComprasType.EliminarCondiciondePago, _dtSecurity))
