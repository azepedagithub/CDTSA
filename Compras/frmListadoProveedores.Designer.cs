namespace CO
{
    partial class frmListadoProveedores
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ColCondicionPago.Width = 112;
			// 
			// txtIDProveedor
			// 
