namespace CO
{
    partial class frmCondicionesDePago
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCondicionesDePago));
			...
			this.txtDescContado = new DevExpress.XtraEditors.TextEdit();
			this.txtDias = new DevExpress.XtraEditors.TextEdit();
			this.txtDescr = new DevExpress.XtraEditors.TextEdit();
			this.dtgCondicionPago = new DevExpress.XtraGrid.GridControl();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtDescContado.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.dtgCondicionPago)).BeginInit();
			...
			this.ribbonControl.Size = new System.Drawing.Size(693, 143);
			// 
			// btnAgregar
			// 
			...
			this.layoutControl1.Controls.Add(this.txtDescContado);
			this.layoutControl1.Controls.Add(this.txtDias);
			this.layoutControl1.Controls.Add(this.txtDescr);
			this.layoutControl1.Controls.Add(this.dtgCondicionPago);
			...
			this.chkActivo.Size = new System.Drawing.Size(52, 19);
			...
			this.txtDescContado.TabIndex = 7;
			// 
			// txtDias
			// 
			...
			this.txtDias.StyleController = this.layoutControl1;
			...
			this.emptySpaceItem1.Text = "Listado de Condiciones de Pago";
			this.emptySpaceItem1.TextSize = new System.Drawing.Size(99, 0);
			...
			// layoutControlItem3
			// 
			this.layoutControlItem3.Control = this.txtDias;
			...
			this.layoutControlItem3.Text = "Días:";
			...
			// layoutControlItem4
			// 
			this.layoutControlItem4.Control = this.txtDescContado;
			...
			this.layoutControlItem4.Text = "Descuento Contado:";
			...
			this.emptySpaceItem4.Size = new System.Drawing.Size(673, 24);
			...
			this.Text = "frmCondicionesDePago";
			this.Load += new System.EventHandler(this.frmCondicionesDePago_Load);
			((System.ComponentModel.ISupportInitialize)(this.ribbonControl)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
			this.layoutControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.chkActivo.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txtDescContado.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.dtgCondicionPago)).EndInit();
        ...
        private DevExpress.XtraGrid.GridControl dtgCondicionPago;
        ...
        private DevExpress.XtraLayout.EmptySpaceItem emptySpaceItem1;
				...
				private DevExpress.XtraEditors.TextEdit txtDescContado;
