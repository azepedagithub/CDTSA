...
Public Class frmCPConsultaDocs
    ...
    Dim psIDProveedor As String = "", psIDVendedor As String = "", psFechaDesde As String, psFechaHasta As String, psDocumento As String

    Dim gIDProveedor As Int32
    Dim gsNombre As String
    Dim gIDDocPago As Int32
    ...
    Private Sub CallPopUpProveedor()
        Try
            ...
            If frm.gsIDProveedor <> "" Then
                Me.txtProveedor.EditValue = frm.gsIDProveedor
    ...
    Sub CargagridLookUpsFromTables()
        CargagridSearchLookUp(Me.SearchLookUpEditClase, "cppClaseDocumento", "IDClase, Descr", "Activo=1  ", "Orden", "Descr", "IDClase")
        CargagridSearchLookUp(Me.SearchLookUpEditSubTipo, "cppSubTipoDocumento", "IDSubTipo, Descr", "", "IDSubTipo", "Descr", "IDSubTipo")
    End Sub
    ...
    Private Sub RefrescaFiltro()
        Try
            ...
            If Me.txtProveedor.EditValue IsNot Nothing Then
                If txtProveedor.Text <> "" Then
                    psIDProveedor = Me.txtProveedor.EditValue.ToString()
                Else
                    psIDProveedor = "0"
                End If
            ...
            spParameters = psIDProveedor & "," & psFechaDesde & "," & psFechaHasta & "," & psDocumento & "," & psIDClase & "," & _
                psIDSubTipo & "," & psAprobado & "," & psAnulado & "," & psSaldos & "," & psContabilizado
            tableData = cManager.ExecSPgetData("cppGetMovimientos", spParameters)
    ...
    Private Sub BarButtonItemAplicar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItemAplicar.ItemClick
        ...
        If dr IsNot Nothing Then
            ...
            If dr("TipoDocumento").ToString() = "C" Then
                MessageBox.Show("No se puede Aplicar un Crédito ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return
            End If
            If dr("TipoDocumento").ToString() = "D" And CBool(dr("Aprobado")) = False Then
                MessageBox.Show("No se puede Aplicar un Débito sin estar Aprobado ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return
            End If
        ...
        If gsClase <> "" Then
            ...
            frm.gbAplicar = True
            frm.gsClase = gsClase
            frm.gIDProveedor = gIDProveedor
            frm.gsNombre = gsNombre
            frm.gIDDocPago = gIDDocPago
    ...
    Private Sub getDataRowFromGridParaAplicar()
        ...
        gsClase = ""
        If dr IsNot Nothing Then
            If dr("TipoDocumento").ToString() = "D" And CDec(dr("SaldoDebito")) > 0 Then
    ...
    Private Sub BarButtonItemDesaplicar_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BarButtonItemDesaplicar.ItemClick
        Try
            ...
            If dr IsNot Nothing Then
                ...
                End If
                If dr("TipoDocumento").ToString() = "D" And CBool(dr("Aprobado")) = False Then
                    MessageBox.Show("No se puede Desaplicar un Débito sin estar Aplicado ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return
                End If
