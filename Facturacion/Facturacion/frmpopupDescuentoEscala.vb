...
Public Class frmpopupDescuentoEscala
    Dim cManager As New ClassManager
    Dim tableData As New DataTable()
    Public gsProductoID As String
    Public gsIDNivel As String
    Public gsIDMoneda As String
    Private Sub frmpopupDescuentoEscala_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub RefreshGrid()
        Try
            tableData = cManager.ExecSPgetData("fafprintTablaDescuentoEscalaPrecios", "0," & gsIDNivel & "," & gsIDMoneda)
