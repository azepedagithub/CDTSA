...
Partial Public Class rptDesglosePagos
    ...
    Private Sub InitializeComponent()
        ...
        Me.piIDVendedor = New DevExpress.XtraReports.Parameters.Parameter()
        ...
        'XrLabel13
        '
        Me.XrLabel13.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.IDClase")})
        ...
        'XrLabel17
        '
        Me.XrLabel17.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.IDDebito")})
        ...
        'XrLabel18
        '
        Me.XrLabel18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.DocDebito")})
        ...
        'XrLabel19
        '
        Me.XrLabel19.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.DiasVencidos")})
        ...
        'XrLabel20
        '
        Me.XrLabel20.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.Vencimiento", "{0:dd/MM/yyyy}")})
        ...
        'XrLabel21
        '
        Me.XrLabel21.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.Aplicado", "{0:n2}")})
        ...
        'XrLabel22
        '
        Me.XrLabel22.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.AplicadoDolar", "{0:n2}")})
        ...
        StoredProcQuery1.Name = "ccfrptDesglosePagos"
        ...
        QueryParameter2.Name = "@IDBodega"
        QueryParameter2.Type = GetType(DevExpress.DataAccess.Expression)
        QueryParameter2.Value = New DevExpress.DataAccess.Expression("[Parameters.piIDBodega]", GetType(Integer))
        QueryParameter3.Name = "@IDVendedor"
        QueryParameter3.Type = GetType(DevExpress.DataAccess.Expression)
        QueryParameter3.Value = New DevExpress.DataAccess.Expression("[Parameters.piIDVendedor]", GetType(Integer))
        QueryParameter4.Name = "@FECHAINICIAL"
        QueryParameter4.Type = GetType(DevExpress.DataAccess.Expression)
        QueryParameter4.Value = New DevExpress.DataAccess.Expression("[Parameters.pdFechaInicial]", GetType(Date))
        QueryParameter5.Name = "@FECHAFINAL"
        QueryParameter5.Type = GetType(DevExpress.DataAccess.Expression)
        QueryParameter5.Value = New DevExpress.DataAccess.Expression("[Parameters.pdFechaFinal]", GetType(Date))
        StoredProcQuery1.Parameters.Add(QueryParameter1)
        StoredProcQuery1.Parameters.Add(QueryParameter2)
        StoredProcQuery1.Parameters.Add(QueryParameter3)
        StoredProcQuery1.Parameters.Add(QueryParameter4)
        StoredProcQuery1.Parameters.Add(QueryParameter5)
        StoredProcQuery1.StoredProcName = "ccfrptDesglosePagos"
        ...
        Me.GroupHeaderBand1.GroupFields.AddRange(New DevExpress.XtraReports.UI.GroupField() {New DevExpress.XtraReports.UI.GroupField("DocCredito", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)})
        ...
        'XrLabel6
        '
        Me.XrLabel6.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.IDClaseCredito")})
        ...
        'XrLabel2
        '
        Me.XrLabel2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.DocCredito")})
        ...
        Me.XrLabel14.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.FechaCredito", "{0:dd/MM/yyyy}")})
        ...
        Me.XrLabel15.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.TotalCredito", "{0:n2}")})
        ...
        Me.XrLabel15.LocationFloat = New DevExpress.Utils.PointFloat(466.7993!, 7.446808!)
        ...
        Me.XrLabel7.LocationFloat = New DevExpress.Utils.PointFloat(108.4244!, 105.9328!)
        Me.XrLabel7.Name = "XrLabel7"
        Me.XrLabel7.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96.0!)
        Me.XrLabel7.SizeF = New System.Drawing.SizeF(59.04562!, 17.28001!)
        Me.XrLabel7.StylePriority.UseFont = False
        Me.XrLabel7.Text = "IDDebito"
        '
        'XrLabel8
        '
        ...
        'XrLabel24
        '
        Me.XrLabel24.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.Aplicado", "{0:C2}")})
        ...
        'XrLabel25
        '
        Me.XrLabel25.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.AplicadoDolar")})
        ...
        'XrLabel27
        '
        Me.XrLabel27.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.Aplicado", "{0:C2}")})
        ...
        'XrLabel28
        '
        Me.XrLabel28.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.AplicadoDolar", "{0:C2}")})
        ...
        Me.piIDBodega.ValueInfo = "1"
        Me.piIDBodega.Visible = False
        '
        'piIDVendedor
        '
        Me.piIDVendedor.Description = "Parameter1"
        Me.piIDVendedor.Name = "piIDVendedor"
        Me.piIDVendedor.Type = GetType(Integer)
        Me.piIDVendedor.ValueInfo = "1"
        Me.piIDVendedor.Visible = False
        '
        'pdFechaInicial
        '
        ...
        Me.XrLabel16.LocationFloat = New DevExpress.Utils.PointFloat(168.9532!, 66.24001!)
        Me.XrLabel16.Name = "XrLabel16"
        Me.XrLabel16.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96.0!)
        Me.XrLabel16.SizeF = New System.Drawing.SizeF(54.11996!, 22.08!)
        ...
        Me.lblNombreReporte.Text = "Desglose de Pagos Recibidos"
        ...
        'XrLabel31
        '
        Me.XrLabel31.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.MonedaCredito")})
        ...
        'XrLabel32
        '
        Me.XrLabel32.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.MonedaDebito", "{0:dd/MM/yyyy}")})
        ...
        Me.XrPanel1.LocationFloat = New DevExpress.Utils.PointFloat(1.702128!, 2.553191!)
        Me.XrPanel1.Name = "XrPanel1"
        Me.XrPanel1.SizeF = New System.Drawing.SizeF(722.2979!, 28.93617!)
        ...
        'XrLabel37
        '
        Me.XrLabel37.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "ccfrptDesglosePagos.FechaDebito", "{0:dd/MM/yyyy}")})
        ...
        Me.DataMember = "ccfrptDesglosePagos"
        Me.DataSource = Me.SqlDataSource1
        Me.Dpi = 96.0!
        Me.Margins = New System.Drawing.Printing.Margins(45, 47, 28, 96)
        Me.PageHeight = 1056
        Me.PageWidth = 816
        Me.Parameters.AddRange(New DevExpress.XtraReports.Parameters.Parameter() {Me.psEmpresa, Me.psCliente, Me.piIDCliente, Me.piIDBodega, Me.piIDVendedor, Me.pdFechaInicial, Me.pdFechaFinal})
    ...
    Friend WithEvents piIDVendedor As DevExpress.XtraReports.Parameters.Parameter
