...
Public Class frmCCFAplicaCreditos
    ...
    Public gIDCliente As Int32
    Public gsNombre As String
    Public gIDCredito As Int32
    ...
    Private Sub frmCCFAplicaCreditos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.txtIDCliente.EditValue = gIDCliente
        ...
        Else
            ...
            Me.Text = "Aplicaciones de un Credito"
    ...
    Sub RefreshGridToPay()
        Try
            ...
            sIDCliente = gIDCliente.ToString()
    ...
    Sub RefreshGridAplicacion()
        Try
            Dim sParametros As String
            sParametros = gIDCredito.ToString()
            tableData = cManager.ExecSPgetData("ccfgetAplicacion", sParametros)
        ...
        Try
            ...
            If tableData.Rows.Count > 0 Then
                ...
                If drSelect.Length > 0 Then
                    ...
                    Dim dTipoCambio As Decimal = getTipoCambio(gdFecha, gParametros.TipoCambioFact)
                    For Each row As DataRow In drSelect
                        sparameterValues = "'I', " & row("IDDebito").ToString() & "," & gIDCredito.ToString() & ","
                        sparameterValues = sparameterValues & Math.Round(CDec(row("Abono")), 4).ToString() & ",'" & gsUsuario & "',"
                        sparameterValues = sparameterValues & gdTipoCambio.ToString() & ",0,"
                        sparameterValues = sparameterValues & "0," & "0,"
                        sparameterValues = sparameterValues & "0," & "0,0"
                        sSql = cManager.CreateStoreProcSql("ccfUpdateAplicaciones", sparameterValues)
                        Dim clase = New CbatchSQLIitem(sSql, False, False, False, False, "ccfUpdateAplicaciones", "ccfUpdateAplicaciones")
    ...
    Private Sub btnReversaDocumento_Click(sender As Object, e As EventArgs) Handles btnReversaDocumento.Click
        ...
        Try
            If dr IsNot Nothing Then
                If MessageBox.Show("Está seguro de eliminar  la Aplicacion para el Documento  " & dr("DocDebito").ToString(), "Advertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = vbNo Then
                    Exit Sub
                End If
                Dim sParametros As String = "0," & dr("IDAplicacion").ToString()
                If cManager.ExecSP("ccfDesAplicar", sParametros) Then
    ...
    Private Sub btnReversaAplicacion_Click(sender As Object, e As EventArgs) Handles btnReversaAplicacion.Click
        ...
        Try
            If dr IsNot Nothing Then
                Dim sParametros As String = gIDCredito.ToString() & ",0"
                If cManager.ExecSP("ccfDesAplicar", sParametros) Then
