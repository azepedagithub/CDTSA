namespace ControlBancario
{
    partial class frmListadoDocumentosBancarios
    {
        ...
        private void InitializeComponent()
        {
			...
			this.cEstadoMov = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.cPagaderoa.VisibleIndex = 5;
			// 
			// Monto
			// 
			...
			// CReferencia
			// 
			this.CReferencia.Caption = "Numero";
			this.CReferencia.FieldName = "Numero";
			this.CReferencia.Name = "CReferencia";
			this.CReferencia.Visible = true;
			this.CReferencia.VisibleIndex = 8;
			// 
			// CConceptoContable
			// 
			this.CConceptoContable.Caption = "Concepto";
			...
			this.CConceptoContable.VisibleIndex = 9;
			// 
			// cEstadoMov
			// 
			this.cEstadoMov.Caption = "Estado";
			this.cEstadoMov.FieldName = "DescrEstado";
			this.cEstadoMov.Name = "cEstadoMov";
			this.cEstadoMov.Visible = true;
			this.cEstadoMov.VisibleIndex = 10;
			// 
			// layoutControlGroup1
			// 
		...
		private DevExpress.XtraGrid.Columns.GridColumn cEstadoMov;
