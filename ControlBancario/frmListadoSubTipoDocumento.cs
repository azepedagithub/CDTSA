...
namespace ControlBancario
{
    public partial class frmListadoSubTipoDocumento : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosControlBancarioType.AgregarSubTipoDocumento, _dtSecurity))
                this.btnAgregar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosControlBancarioType.EditarSubTipoDocumento, _dtSecurity))
                this.btnEditar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosControlBancarioType.EliminarSubTipoDocumento, _dtSecurity))
                this.btnEliminar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosControlBancarioType.ExportarSubTipoDocumento, _dtSecurity))
