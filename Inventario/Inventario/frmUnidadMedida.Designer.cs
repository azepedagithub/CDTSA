namespace CI
{
    partial class frmUnidadMedida
    {
        ...
        private void InitializeComponent()
        {
			...
			((System.ComponentModel.ISupportInitialize)(this.txtIDUnidadMedida.Properties)).BeginInit();
			...
			this.layoutControl1.Controls.Add(this.txtIDUnidadMedida);
			this.layoutControl1.Controls.Add(this.dtgUnidadMedida);
			...
			this.chkActivo.Size = new System.Drawing.Size(131, 19);
			...
			this.dtgUnidadMedida.Size = new System.Drawing.Size(712, 189);
			this.dtgUnidadMedida.TabIndex = 4;
			this.dtgUnidadMedida.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gridView1});
			// 
			// gridView1
			// 
			...
			// colIDUnidad
			// 
			this.colIDUnidad.Caption = "ID";
			this.colIDUnidad.FieldName = "IDUnidad";
			this.colIDUnidad.MaxWidth = 94;
			this.colIDUnidad.Name = "colIDUnidad";
			this.colIDUnidad.Visible = true;
			this.colIDUnidad.VisibleIndex = 0;
			this.colIDUnidad.Width = 54;
			// 
			// colDescr
			// 
			...
			this.colDescr.Width = 570;
			// 
			// colActivo
			// 
			this.colActivo.Caption = "Activo";
			this.colActivo.FieldName = "Activo";
			this.colActivo.MaxWidth = 70;
			...
			((System.ComponentModel.ISupportInitialize)(this.txtIDUnidadMedida.Properties)).EndInit();
        ...
        private DevExpress.XtraEditors.TextEdit txtIDUnidadMedida;
        private DevExpress.XtraGrid.GridControl dtgUnidadMedida;
