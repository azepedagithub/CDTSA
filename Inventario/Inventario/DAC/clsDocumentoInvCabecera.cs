...
namespace CI.DAC
{
    public class clsDocumentoInvCabecera
    {
        ...
        {
            String strSQL = "SELECT  IDTransaccion ,IDPaquete,ModuloOrigen ,Fecha ,Usuario,Asiento , Referencia ,Documento ,Aplicado ,UniqueValue ,EsTraslado , IDTraslado ,IsPrestamoPagado,isChildPrestamo, CreateDate  FROM dbo.invTransaccion WHERE 1=2";
