namespace CI
{
    partial class frmListadoProducto
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colGenerico = new DevExpress.XtraGrid.Columns.GridColumn();
    ...
    "na que desea filtrar y escriba una aproximación de su buqueda,";
			...
			this.grdFactorEmpaque.VisibleIndex = 4;
			...
			this.grdEsMuestra.VisibleIndex = 5;
			// 
			// grdEsControlado
			// 
			...
			this.grdEsControlado.VisibleIndex = 6;
			...
			this.grdEsEtico.VisibleIndex = 7;
			...
			// colGenerico
			// 
			this.colGenerico.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.colGenerico.AppearanceHeader.Options.UseFont = true;
			this.colGenerico.Caption = "Genérico";
			this.colGenerico.FieldName = "Generico";
			this.colGenerico.Name = "colGenerico";
			this.colGenerico.Visible = true;
			this.colGenerico.VisibleIndex = 2;
			// 
			// frmListadoProducto
			// 
        ...
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem4;
				private DevExpress.XtraGrid.Columns.GridColumn colGenerico;
    }
}