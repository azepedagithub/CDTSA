...
namespace CI
{
    public partial class frmCatalogoClasificaciones : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosInventarioType.AgregarClasificaciones, _dtSecurity))
                this.btnAgregar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosInventarioType.EditarClasificaciones, _dtSecurity))
                this.btnEditar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosInventarioType.EliminarClasificaciones, _dtSecurity))
                this.btnEliminar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosInventarioType.ExportarClasificaciones, _dtSecurity))
				this.btnExportar.Enabled = false;
			if (!UsuarioDAC.PermiteAccion((int)Acciones.PrivilegiosInventarioType.MostrarGrupodeClasificaciones, _dtSecurity))
